...
const internships = [
  {
    ...
    image: `${import.meta.env.BASE_URL}stronghold.jpg`,
    tasks: [
  ...
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}ojt2.jpg`,
    imagePosition: "right",
    tasks: [
          ...
          {internships.map((item, index) => (
            <div className="about-internships-item" key={item.company + item.duration}>
              ...
              <div className="about-internships-card">
                <div className="about-internships-card-inner">
                  <div className="about-internships-card-content">
                  ...
                  {item.image && (
                    <div className="about-internships-card-image-wrapper">
                      <img
                        src={item.image}
                        alt={item.company}
                        className="about-internships-card-image"
